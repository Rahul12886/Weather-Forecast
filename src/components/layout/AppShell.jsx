  ...
  return (
    <div
      className={`h-screen overflow-hidden ${
        theme === 'dark' ? 'weather-night' : bgClass
      } transition-colors duration-700`}
    >
      <div
        ref={scrollContainerRef}
        className="h-full overflow-y-auto bg-white/20 px-3 py-3 backdrop-blur-[1px] dark:bg-slate-950/28 sm:px-5 lg:px-6"
      >
        <header className="mx-auto flex max-w-7xl flex-col gap-2 py-1 min-[560px]:flex-row min-[560px]:items-center min-[560px]:justify-between">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <NavLink to="" className="flex items-center gap-2">
              ...
              <div>
                <p className="font-display text-lg font-semibold leading-5 tracking-normal text-sky-600 dark:text-sky-200">
                  Nimbus
                </p>

                <p className="hidden text-xs font-semibold uppercase text-slate-500 dark:text-slate-300 xl:block">
